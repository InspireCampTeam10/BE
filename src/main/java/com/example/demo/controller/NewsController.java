...
public class NewsController {
    ...
    @GetMapping("/history")
    public ApiResponse<List<NewsResponseDto>> getLatestFitNews(@AuthenticationPrincipal User user){
    ...
    public ApiResponse<String> generateNewsResponse(@AuthenticationPrincipal User user,
    ...
    @PostMapping("/search")
    public ApiResponse<List<GenerateNewsResponseDto>> generateNewsResponse(@AuthenticationPrincipal User user,
